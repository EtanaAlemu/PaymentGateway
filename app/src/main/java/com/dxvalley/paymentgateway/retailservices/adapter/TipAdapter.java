...
public class TipAdapter extends
    ...
    private TipItemClickListener clickListener;

    public void setClickListener(TipItemClickListener tipClickListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            if (clickListener != null)  clickListener.onTipClick(view, getAdapterPosition()); // call the onClick in the OnItemClickListener
        }
    }
